...
const paletteScript = `(function(){try{var p={default:{b:'#ffffff',f:'#000000',m:'#6b6b6b',r:'#e0e0e0'},midnight:{b:'#111111',f:'#e8e8e6',m:'#8a8a8a',r:'#2a2a2a'},vermillion:{b:'#a01010',f:'#f0e8e0',m:'#d09088',r:'#881010'},amber:{b:'#f2a200',f:'#6a0d69',m:'#8a5800',r:'#d89000'},marine:{b:'#1843b4',f:'#fc6e0e',m:'#7090c8',r:'#143898'},violet:{b:'#9d19b3',f:'#8aff44',m:'#c890d8',r:'#881098'},jade:{b:'#21a87f',f:'#fefd75',m:'#78c8a8',r:'#1a9070'},sol:{b:'#E8E83A',f:'#1843b3',m:'#989810',r:'#d8d810'},azure:{b:'#1077f8',f:'#effb72',m:'#78b0f0',r:'#0c60d0'}};var id=localStorage.getItem('palette')||'default';var t=p[id];if(t){var s=document.documentElement.style;s.setProperty('--bg',t.b);s.setProperty('--fg',t.f);s.setProperty('--fg-muted',t.m);s.setProperty('--border-color',t.r)}}catch(e){}})()`;
